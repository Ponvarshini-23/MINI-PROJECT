               ...
               <div class="container">
                    <div class="row">
                      ...
                      <form action="SRegister" method="post" enctype="multipart/form-data"> 
                            ...
                            <tr><td><strong>Register No&emsp; </strong></td><td><input type="text" name="id" value="" style="border-radius: 10px; color: #2f323a; background-color: #4ECDC4;" required></td></tr>
                            ...
                            <tr><td align="center" colspan="2"><button type="submit" style=" margin-left: -60px; color: #F1C111; font-size: 15px; background-color:black; font-family:monospace;">Register</button> </td></tr>
                                                           </table></form>
